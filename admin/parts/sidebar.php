...
<aside class="app-sidebar">
        ...
        <ul class="app-menu">
                <li><a class="app-menu__item" href="dashboard.php"><i class="app-menu__icon bi bi-columns-gap"></i><span class="app-menu__label">Dashboard</span></a></li>
                <li><a class="app-menu__item" href="user_view.php"><i class="app-menu__icon bi bi-people"></i><span class="app-menu__label">Users</span></a></li>
                <li><a class="app-menu__item" href="section_view.php"><i class="app-menu__icon bi bi-check2-square"></i><span class="app-menu__label">Sections</span></a></li>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-ui-checks"></i><span class="app-menu__label">Section Option</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-heart-pulse"></i><span class="app-menu__label">ECG</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                                <li><a class="treeview-item" href="ecg_add.php"><i class="icon bi bi-circle-fill"></i>
                                                Add ECG</a></li>
                                <li><a class="treeview-item" href="ecg_view.php"><i class="icon bi bi-circle-fill"></i> View ECG</a></li>
                        </ul>
                </li>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-patch-question"></i><span class="app-menu__label">Question</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                ...
                <?php if(!isset($_SESSION['admin_email'])){?>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-file-earmark"></i><span class="app-menu__label">Answer</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-code-square"></i><span class="app-menu__label">ECG Attempt</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                ...
                <?php } ?>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-file-pdf"></i><span class="app-menu__label">Document</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
             ...
             <!--   <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-files"></i><span class="app-menu__label">Pop Quiz</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-camera-reels"></i><span class="app-menu__label">Reels</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                                <li><a class="treeview-item" href="reel_add.php"><i class="icon bi bi-circle-fill"></i>
                                                Add Reel</a></li>
                                <li><a class="treeview-item" href="reel_view.php" rel="noopener"><i class="icon bi bi-circle-fill"></i> View Reel</a></li>

                        </ul>
                </li>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-person-video3"></i><span class="app-menu__label">Lectures</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                        <ul class="treeview-menu">
                                <li><a class="treeview-item" href="lecture_add.php"><i class="icon bi bi-circle-fill"></i>
                                                Add Lecture</a></li>
                                <li><a class="treeview-item" href="lecture_view.php" rel="noopener"><i class="icon bi bi-circle-fill"></i> View Lecture</a></li>

                        </ul>
                </li>
                <li><a class="app-menu__item" href="page.php"><i class="app-menu__icon bi bi-file-earmark"></i><span class="app-menu__label">Pages</span></a></li>
                <li><a class="app-menu__item" href="setting.php"><i class="app-menu__icon bi bi bi-gear"></i><span class="app-menu__label">Settings</span></a></li>
